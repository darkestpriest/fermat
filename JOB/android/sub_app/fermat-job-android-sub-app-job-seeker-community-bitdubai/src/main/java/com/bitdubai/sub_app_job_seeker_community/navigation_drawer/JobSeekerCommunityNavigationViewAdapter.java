 ...
 */
public class JobSeekerCommunityNavigationViewAdapter  extends
        FermatAdapter<
                MenuItem,
                NavigationItemMenuViewHolder> {

    protected JobSeekerCommunityNavigationViewAdapter(Context context) {
        super(context);
    }
    ...
    protected int getCardViewResource() {
        return R.layout.jjsc_row_navigation_drawer_community_content;
    }
    ...
    private void bindMenuItem(NavigationItemMenuViewHolder holder, int position) {
        switch (position) {
            case 0:
                holder.getIcon().setImageResource(R.drawable.jjsc_ic_nav_friends);
                break;
            case 1:
                holder.getIcon().setImageResource(R.drawable.jjsc_ic_nav_connections);
                break;
            case 2:
                holder.getIcon().setImageResource(R.drawable.jjsc_ic_nav_notifications);
                break;
        }
    }
