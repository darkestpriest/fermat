 ...
 */
public class JobSeekerActorNetworkServiceDeveloperDatabaseFactory {
     ...
     * @param pluginId
     */
    public JobSeekerActorNetworkServiceDeveloperDatabaseFactory(
    ...
    public void initializeDatabase(final String tableId) throws CantInitializeDatabaseException {
        ...
        switch (tableId) {
            ...
            case JobSeekerActorNetworkServiceDatabaseConstants.JOB_SEEKER_ACTOR_NETWORK_SERVICE_DATABASE_NAME:
                ...
                try {
                    ...
                    final JobSeekerActorNetworkServiceDatabaseFactory jobSeekerActorNetworkServiceDatabaseFactory 
                    ...
                    try {
                        ...
                        throw new CantInitializeDatabaseException(
                                z, 
                                "tableId: " + tableId, 
                                "Error trying to create the database.");
                    }
                }
                break;
            ...
            case CommunicationNetworkServiceDatabaseConstants.DATA_BASE_NAME:
                try {
                    ...
                    try {
                        ...
                        this.database = communicationLayerNetworkServiceDatabaseFactory
                                .createDatabase(
                                        pluginId,
                                        CommunicationNetworkServiceDatabaseConstants.DATA_BASE_NAME);
    ...
    public List<DeveloperDatabaseTable> getDatabaseTableList(final DeveloperObjectFactory developerObjectFactory,
        ...
        switch (developerDatabase.getId()) {
            ...
            case JobSeekerActorNetworkServiceDatabaseConstants.JOB_SEEKER_ACTOR_NETWORK_SERVICE_DATABASE_NAME:
                ...
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_ID_COLUMN_NAME            );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_PUBLIC_KEY_COLUMN_NAME     );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_ACTOR_TYPE_COLUMN_NAME     );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENDER_ALIAS_COLUMN_NAME          );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_DESTINATION_PUBLIC_KEY_COLUMN_NAME);
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_TYPE_COLUMN_NAME          );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_STATE_COLUMN_NAME         );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_REQUEST_ACTION_COLUMN_NAME        );
                connectionNewsColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_SENT_TIME_COLUMN_NAME             );
                /**
                 * Table Connection News addition.
                 */
                DeveloperDatabaseTable connectionNewsTable = developerObjectFactory.getNewDeveloperDatabaseTable(JobSeekerActorNetworkServiceDatabaseConstants.CONNECTION_NEWS_TABLE_NAME, connectionNewsColumns);
                ...
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_REQUEST_ID_COLUMN_NAME              );
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_REQUESTER_PUBLIC_KEY_COLUMN_NAME    );
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_REQUESTER_ACTOR_TYPE_COLUMN_NAME    );
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_JOB_SEEKER_PUBLIC_KEY_COLUMN_NAME);
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_UPDATE_TIME_COLUMN_NAME             );
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_TYPE_COLUMN_NAME                    );
                quotesRequestColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_STATE_COLUMN_NAME                   );

                /**
                 * Table Quotes Request addition.
                 */
                DeveloperDatabaseTable quotesRequestTable = developerObjectFactory.getNewDeveloperDatabaseTable(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_TABLE_NAME, quotesRequestColumns);
                ...
                quotesColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_REQUEST_ID_COLUMN_NAME           );
                quotesColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_INNER_ID_COLUMN_NAME          );
                quotesColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_OWNER_PUBLIC_KEY_COLUMN_NAME     );
                quotesColumns.add(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_XML_STRING_COLUMN_NAME     );

                /**
                 * Table Quotes addition.
                 */
                DeveloperDatabaseTable quotesTable = developerObjectFactory.getNewDeveloperDatabaseTable(JobSeekerActorNetworkServiceDatabaseConstants.RESUME_TABLE_NAME, quotesColumns);
