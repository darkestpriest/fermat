package org.fermat.fermat_job_plugin.layer.sub_app_module.job_seeker_community.developer;
...
public class DeveloperBitDubai extends AbstractPluginDeveloper implements PluginLicensor {
    ...
    public void start() throws CantStartPluginDeveloperException {
        try {
            this.registerVersion(new JobSeekerCommunitySubAppModulePluginRoot());
